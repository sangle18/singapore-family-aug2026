# 🇸🇬 Singapore Family Master Plan
**28/8 → 1/9/2026** | 2 Adults + 1 Toddler (sinh 20/9/2023 ≈ 2 tuổi 11 tháng) + Chilux

**Base:** Novotel Singapore on Stevens — 28 Stevens Road  
**Hotel:** S$839.08 / 4 đêm (S$209.77/đêm) ✅ đã trả  
**Bay:** Scoot SGN T2 09:15 (28/8) → SIN | SIN T1 13:25 (1/9) → SGN T2

---

## Cách dùng file này
- **Google Calendar:** Import file `Singapore-Family-28Aug-1Sep2026.ics`  
  Calendar → Settings → Import & export → Import
- **Apple Notes / Notion / Obsidian:** Copy nguyên file `.md` này

---

## Timeline 5 ngày

### DAY 1 — Thứ Sáu 28/8 | Changi → Jewel → Hotel
| Giờ | Việc |
|-----|------|
| 06:45–07:00 | Tân Sơn Nhất **T2** – Scoot check-in + tag Chilux |
| 09:15 | Bay SGN → SIN |
...
|------|----------|-------------------------------------|
| 1 Jewel → hotel | Grab | Không — vali + Chilux. Bus 36 Changi → Orchard rồi còn đổi |
| 2 sáng Zoo | Grab 08:15 | Không — xe **M2** Khatib chỉ từ 8:30, trễ cửa Zoo |
| 2 chiều về | Grab | **138** từ Zoo (48131) → Springleaf, TEL về Stevens. Hoặc **M2** → Khatib rồi MRT |
...
## Budget tại Singapore (ước tính)
| Khoản | SGD |
|-------|-----|
| Hotel | 839 ✅ |
| Attractions | ~390 |
| Food | 250–320 |
| Grab + Sentosa entry + MRT | 130–180 |
| SIM | 12–30 |
| Misc | ~100 |
| **Tổng** | **~1.720–1.860** |
